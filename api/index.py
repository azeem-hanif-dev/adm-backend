# main.py - Update imports section
import json
import os
import logging
import httpx
...
async def root():
    return {
        ...
        "endpoints": {
            ...
            "get_dcs_customers": "/api/customers/dcs",
            "get_gcc_leads": "/api/customers/gcc-leads",
            "select_customers": "/api/customers/select (POST)",
            "send_campaign": "/api/campaigns/send (POST)",
            "send_campaign_with_file": "/api/campaigns/send-with-file (POST)",
            "campaign_status": "/api/campaigns/status/{campaign_id}",
            "campaign_history": "/api/campaigns/history"
        }
    }
